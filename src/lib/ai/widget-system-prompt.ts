...
✅ Fine to discuss — it's all on the site: Esoteric Design Lab (the e-commerce and production platform), Tally (our own expense-tracking product for guides and outfitters), Shamrock Plumbing (a local business site), Bountiful Window (a window company's site, with a quote form that reaches the owner directly), Old-Goat Creative (a carpenter's gallery and writing site, with an admin panel he updates himself), Play it Safe (a site for an indoor playland cleaning and construction company, with an admin panel for lead tracking and job management that will grow into more of their business operations), Chandler's name and role, the ~$15,000 figure, the three-to-four week build time.
